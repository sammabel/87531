...
Battle_Hud.prototype.create_face = function() {
	...
	if (!this._battler) {return};	
	this._face = new Sprite(ImageManager.loadBHud("Face_" + $gameVariables.value(140 + this._battler._actorId)));//new Sprite(ImageManager.loadBHud("Face_" + this._battler._actorId));
